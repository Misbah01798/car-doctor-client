        ...
        <div>
            ...
            <div className="hero min-h-screen bg-orange-200">
                <div className="hero-content flex-col lg:flex-row space-x-14">
                    ...
                    <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100 bg-opacity-25">
                        ...
                        <h1 className="text-center text-2xl font-bold mb-4">Have not an account? <Link to="/signUp" className="text-3xl text-red-500">Sign Up</Link></h1>
                    </div>
                </div>
            </div>
